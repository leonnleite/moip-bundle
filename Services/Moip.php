...
class Moip 
{
    ...
    */
	 ...
	 * @return Moip
     */
    public function setEnvironment($testing = 'test') {
    ...
    public function getXML() {
        ...
        $this->xml->InstrucaoUnica->addChild('CancelarPagamento');
        $this->xml->InstrucaoUnica->CancelarPagamento->addChild('Codigo','97709');
