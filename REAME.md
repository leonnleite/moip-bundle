...
**Second Way** : git command
    ...
    git submodule add git://github.com/leonnleite/Tear-MoipBundle.git vendor/tear/moip-bundle/Tear/MoipBundle/
...
more in https://github.com/moiplabs/moip-php/